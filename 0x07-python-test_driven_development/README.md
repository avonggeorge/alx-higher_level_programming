# Python - Test-driven development :page_with_curl: 0x07-python-test_driven_development
## About this project:
 ...
 * [0-add_integer.py](./0-add_integer.py): Python function that returns the integer addition
  ...
  * [102-python.c](./102-python.c): C function that prints basic information about Python
  string objects.
## Test files: 
This tests files developed to test the programs as well as test the actual concept
of test driven developments.
